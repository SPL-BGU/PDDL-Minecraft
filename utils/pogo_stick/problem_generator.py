...
class ProblemGenerator:
    def __init__(self, output_dir="dataset/"):
        self.example_map_path = "utils/pogo_stick/pogo_stick.json"
        self.output_directory_path = Path(output_dir)

        self.domain = "planning/pogo_stick/basic_minecraft_domain.pddl"
    ...
    def basic_pddl_minecraft_generate(
        ...
        template = get_problem_template(
            Path("utils/pogo_stick/basic_problem_template.pddl")
        )
        template_mapping = {
    ...
    def advanced_pddl_minecraft_generate(
        ...
        """
        template = get_problem_template(
            Path("utils/pogo_stick/advanced_problem_template.pddl")
        )
        template_mapping = {
            "instance_name": instance_name,
            "cell_list": " ".join(
                ...
                with open(
                    ...
                    problem_file.write(
                        self.advanced_pddl_minecraft_generate(
                            ...
                            count_tree_tap_in_inventory=items_count[
                                "polycraft:tree_tap"
                            ],
                        )
                    )
